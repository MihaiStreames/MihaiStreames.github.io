...
<section>
  <div class="code-block">
    ...
    <div class="indent">
      ...
      <div class="indent">
        <p>
          <span class="py-self">self</span>.role = <span class="py-string">"{me.role}"</span>
        </p>
        <p>
          <span class="py-self">self</span>.focus = <span class="py-string">"{me.focus}"</span>
        </p>
        <p>
        ...
        <p>
          <span class="py-self">self</span>.also = <span class="py-string">"{me.also}"</span>
        </p>
      </div>
    </div>
  </div>
